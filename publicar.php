...
if(isset($_POST['submit'])){
	...
	echo $sql;
	echo $titulo,$categoria,$descripcion,$fecha,$ciudad,$imagen,$id,$precio;
	...
	<div class="row">
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
			<div class="col-8">
				...
				<textarea name="descripcion" id="" cols="54" rows="4">
				...
				<input type="number" class="casilla" name="precio" required>
				<hr>
				<label for="">Ciudad:</label><br>
				<input type="text" class="casilla" name="ciudad">
				<hr>
